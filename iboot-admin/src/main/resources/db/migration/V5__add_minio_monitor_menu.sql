...
VALUES (706, '对象存储监控', 7, 'C', '/monitor/minio-monitor', 'monitor/minio-monitor/index', 'monitor:minio', 'box', 5, 1, 1, 'system', NOW());
...
VALUES (56, 'MinIO控制台地址', 'sys.minio.console.url', 'http://localhost:9001', 1, 'system', NOW(), 0, 'MinIO管理控制台访问地址');

-- 为超级管理员角色分配 MinIO 监控权限
INSERT INTO `sys_role_menu` (`role_id`, `menu_id`) VALUES (1, 706);
INSERT INTO `sys_role_menu` (`role_id`, `menu_id`) VALUES (1, 7061);
