...
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `email`, `phone`, `gender`, `user_type`, `dept_id`,
                        `status`, `create_by`, `remark`)
VALUES (1, 'admin', '$2a$10$uAKzTVTib3zNyrwLAZt5UemckqbOMOaBBQfewspf01jKbkhs/ENpW', '管理员', 'admin@iboot.com',
        '18888888888', 1, 1, 1, 1, 'system', '系统管理员');
...
INSERT INTO `sys_menu` (`id`, `menu_name`, `parent_id`, `menu_type`, `path`, `component`, `permission`, `icon`,
                        `order_num`, `visible`, `status`, `create_by`)
VALUES (200, '部门管理', 2, 'C', '/organization/dept', 'organization/dept/index', 'dept:list', 'tree', 1, 1, 1,
        'system');
...
INSERT INTO `sys_menu` (`id`, `menu_name`, `parent_id`, `menu_type`, `path`, `component`, `permission`, `icon`,
                        `order_num`, `visible`, `status`, `create_by`)
VALUES (201, '岗位管理', 2, 'C', '/organization/post', 'organization/post/index', 'post:list', 'post', 2, 1, 1,
        'system');
...
INSERT INTO `sys_menu` (`id`, `menu_name`, `parent_id`, `menu_type`, `path`, `component`, `permission`, `icon`,
                        `order_num`, `visible`, `status`, `create_by`)
VALUES (202, '组织架构图', 2, 'C', '/organization/org-chart', 'organization/org-chart/index', 'orgchart:view', 'chart',
        3, 1, 1, 'system');
...
INSERT INTO `sys_menu` (`id`, `menu_name`, `parent_id`, `menu_type`, `path`, `component`, `permission`, `icon`,
                        `order_num`, `visible`, `status`, `create_by`)
VALUES (300, '登录日志', 3, 'C', '/security/login-log', 'security/login-log/index', 'loginlog:list', 'logininfor', 1, 1,
        1, 'system');
...
INSERT INTO `sys_menu` (`id`, `menu_name`, `parent_id`, `menu_type`, `path`, `component`, `permission`, `icon`,
                        `order_num`, `visible`, `status`, `create_by`)
VALUES (301, '操作日志', 3, 'C', '/security/operate-log', 'security/operate-log/index', 'operatelog:list', 'form', 2, 1,
        1, 'system');
...
INSERT INTO `sys_menu` (`id`, `menu_name`, `parent_id`, `menu_type`, `path`, `component`, `permission`, `icon`,
                        `order_num`, `visible`, `status`, `create_by`)
VALUES (302, '运行日志', 3, 'C', '/security/audit-log', 'security/audit-log/index', 'auditlog:list', 'bug', 3, 1, 1,
        'system');
...
INSERT INTO `sys_menu` (`id`, `menu_name`, `parent_id`, `menu_type`, `path`, `component`, `permission`, `icon`,
                        `order_num`, `visible`, `status`, `create_by`)
VALUES (400, '系统公告', 4, 'C', '/message/notice', 'message/notice/index', 'notice:list', 'notification', 1, 1, 1,
        'system');
...
INSERT INTO `sys_menu` (`id`, `menu_name`, `parent_id`, `menu_type`, `path`, `component`, `permission`, `icon`,
                        `order_num`, `visible`, `status`, `create_by`)
VALUES (401, '消息中心', 4, 'C', '/message/message-center', 'message/message-center/index', 'message:list',
        'chat-dot-round', 2, 1, 1, 'system');
...
INSERT INTO `sys_menu` (`id`, `menu_name`, `parent_id`, `menu_type`, `path`, `component`, `permission`, `icon`,
                        `order_num`, `visible`, `status`, `create_by`)
VALUES (500, '文件管理', 5, 'C', '/file/file-manage', 'file/file-manage/index', 'file:list', 'folder', 1, 1, 1,
        'system');
...
INSERT INTO `sys_menu` (`id`, `menu_name`, `parent_id`, `menu_type`, `path`, `component`, `permission`, `icon`,
                        `order_num`, `visible`, `status`, `create_by`)
VALUES (700, '在线用户监控', 7, 'C', '/monitor/online-user', 'monitor/online-user/index', 'online:list', 'online', 1, 1,
        1, 'system');
...
INSERT INTO `sys_menu` (`id`, `menu_name`, `parent_id`, `menu_type`, `path`, `component`, `permission`, `icon`,
                        `order_num`, `visible`, `status`, `create_by`)
VALUES (701, '服务监控检查', 7, 'C', '/monitor/server-monitor', 'monitor/server-monitor/index', 'server:list', 'server',
        2, 1, 1, 'system');
...
INSERT INTO `sys_menu` (`id`, `menu_name`, `parent_id`, `menu_type`, `path`, `component`, `permission`, `icon`,
                        `order_num`, `visible`, `status`, `create_by`)
VALUES (702, 'Redis缓存监控', 7, 'C', '/monitor/redis-monitor', 'monitor/redis-monitor/index', 'redis:list', 'redis', 3,
        1, 1, 'system');
...
INSERT INTO `sys_menu` (`id`, `menu_name`, `parent_id`, `menu_type`, `path`, `component`, `permission`, `icon`,
                        `order_num`, `visible`, `status`, `create_by`)
VALUES (703, 'SQL执行监控', 7, 'C', '/monitor/sql-monitor', 'monitor/sql-monitor/index', 'monitor:sql', 'sql', 4, 1, 1,
        'system');
...
INSERT INTO `sys_menu` (`id`, `menu_name`, `parent_id`, `menu_type`, `path`, `component`, `permission`, `icon`,
                        `order_num`, `visible`, `status`, `create_by`)
VALUES (704, '系统性能监控', 7, 'C', '/monitor/performance', 'monitor/performance/index', 'monitor:performance',
        'dashboard', 5, 1, 1, 'system');
...
INSERT INTO `sys_menu` (`id`, `menu_name`, `parent_id`, `menu_type`, `path`, `component`, `permission`, `icon`,
                        `order_num`, `visible`, `status`, `create_by`)
VALUES (705, 'Swagger UI', 7, 'C', '/monitor/swagger', 'monitor/swagger/index', 'monitor:swagger', 'api', 6, 1, 1,
        'system');
...
INSERT INTO `sys_menu` (`id`, `menu_name`, `parent_id`, `menu_type`, `path`, `component`, `permission`, `icon`,
                        `order_num`, `visible`, `status`, `create_by`)
VALUES (900, '数据统计报表', 9, 'C', '/analysis/report', 'analysis/report/index', 'report:view', 'pie-chart', 1, 1, 1,
        'system');
...
INSERT INTO `sys_menu` (`id`, `menu_name`, `parent_id`, `menu_type`, `path`, `component`, `permission`, `icon`,
                        `order_num`, `visible`, `status`, `create_by`)
VALUES (901, '系统使用分析', 9, 'C', '/analysis/usage', 'analysis/usage/index', 'usage:view', 'data-analysis', 2, 1, 1,
        'system');
...
-- 4. 初始化部门数据
-- ----------------------------
INSERT INTO `sys_dept` (`id`, `parent_id`, `dept_name`, `dept_code`, `order_num`, `leader`, `phone`, `email`, `status`,
                        `create_by`)
...
INSERT INTO `sys_dict_data` (`id`, `dict_type`, `dict_label`, `dict_value`, `dict_sort`, `list_class`, `is_default`,
                             `status`, `create_by`)
...
INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`, `create_by`, `remark`)
VALUES (9, '文件上传路径', 'sys.file.uploadPath', './uploads', 1, 'system',
        '文件上传的存储根目录，支持相对路径和绝对路径');

INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`, `create_by`, `remark`)
VALUES (10, '文件上传大小限制', 'sys.file.maxSize', '50', 1, 'system', '单个文件上传最大大小，单位MB');

INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`, `create_by`, `remark`)
VALUES (11, '允许上传的文件扩展名', 'sys.file.allowedExtensions',
        'doc,docx,xls,xlsx,ppt,pptx,pdf,txt,md,jpg,jpeg,png,gif,bmp,svg,mp4,avi,mov,mp3,wav,zip,rar,7z,tar,gz', 1,
        'system', '允许上传的文件扩展名列表，逗号分隔');
...
INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`, `create_by`, `remark`)
VALUES (13, '独占会话开关', 'sys.session.exclusive', 'true', 1, 'system',
        '是否开启会话互斥，同一用户同时只能保持一个活跃会话');
...
-- ----------------------------
INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`, `create_by`, `remark`)
VALUES (16, 'Redis内存警告阈值', 'monitor.redis.memory.warn.threshold', '70', 1, 'system',
        'Redis内存使用率达到该百分比时显示警告');

INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`, `create_by`, `remark`)
VALUES (17, 'Redis内存错误阈值', 'monitor.redis.memory.error.threshold', '85', 1, 'system',
        'Redis内存使用率达到该百分比时显示错误');
...
INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`, `create_by`, `remark`)
VALUES (20, '物理内存警告阈值', 'monitor.memory.warn.threshold', '80', 1, 'system',
        '物理内存使用率达到该百分比时显示警告');

INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`, `create_by`, `remark`)
VALUES (21, '物理内存错误阈值', 'monitor.memory.error.threshold', '90', 1, 'system',
        '物理内存使用率达到该百分比时显示错误');

INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`, `create_by`, `remark`)
VALUES (22, 'JVM内存警告阈值', 'monitor.jvm.warn.threshold', '80', 1, 'system',
        'JVM堆内存使用率达到该百分比时显示警告');

INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`, `create_by`, `remark`)
VALUES (23, 'JVM内存错误阈值', 'monitor.jvm.error.threshold', '90', 1, 'system',
        'JVM堆内存使用率达到该百分比时显示错误');

INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`, `create_by`, `remark`)
VALUES (24, '磁盘空间警告阈值', 'monitor.disk.warn.threshold', '80', 1, 'system',
        '磁盘空间使用率达到该百分比时显示警告');

INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`, `create_by`, `remark`)
VALUES (25, '磁盘空间错误阈值', 'monitor.disk.error.threshold', '90', 1, 'system',
        '磁盘空间使用率达到该百分比时显示错误');

INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`, `create_by`, `remark`)
VALUES (26, 'Spring Boot Admin地址', 'monitor.sba.url', '/sba', 1, 'system',
        '监控页面中的Spring Boot Admin控制台链接地址');
...
INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`, `create_by`, `remark`)
VALUES (29, 'API文档地址', 'sys.swagger.api-docs.url', '/v3/api-docs', 1, 'system',
        'OpenAPI接口文档的基础路径，对应springdoc.api-docs.path配置');

INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`, `create_by`, `remark`)
VALUES (30, 'Druid监控地址', 'sys.druid.monitor.url', '/druid', 1, 'system', 'Druid数据库连接池监控页面地址');

INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`, `create_by`, `remark`)
VALUES (31, 'Redis监控自动刷新间隔', 'monitor.redis.refreshInterval', '30', 1, 'system',
        'Redis缓存监控页面自动刷新间隔，单位秒');

INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`, `create_by`, `remark`)
VALUES (32, '在线用户监控刷新间隔', 'sys.online.refreshInterval', '30', 1, 'system',
        '在线用户监控页面自动刷新间隔，单位秒');

INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`, `create_by`, `remark`)
VALUES (33, '性能监控自动刷新间隔', 'monitor.performance.refreshInterval', '30', 1, 'system',
        '系统性能监控页面自动刷新间隔，单位秒');
...
-- 示例消息模板数据
INSERT INTO `sys_message_template` (`id`, `template_code`, `template_name`, `template_content`, `message_type`,
                                    `status`, `create_by`)
VALUES (1, 'WELCOME_TEMPLATE', '欢迎消息模板',
        '亲爱的$${userName}，欢迎加入$${companyName}！您的账号已创建成功，初始密码为：$${password}，请及时登录系统修改密码。',
        '1', 1, 'system');

-- 示例定时任务数据
INSERT INTO `sys_job` (`id`, `job_name`, `job_group`, `invoke_target`, `cron_expression`, `misfire_policy`,
                       `concurrent`, `status`, `remark`, `create_by`)
VALUES (1, '系统默认（无参）', 'DEFAULT', 'sampleTask.noParams', '0/10 * * * * ?', 3, 0, 0, '系统默认示例任务（无参数）',
        'system');

INSERT INTO `sys_job` (`id`, `job_name`, `job_group`, `invoke_target`, `cron_expression`, `misfire_policy`,
                       `concurrent`, `status`, `remark`, `create_by`)
VALUES (2, '系统默认（有参）', 'DEFAULT', 'sampleTask.withParams(\'iboot\')', '0/15 * * * * ?', 3, 0, 0,
        '系统默认示例任务（有参数）', 'system');

INSERT INTO `sys_job` (`id`, `job_name`, `job_group`, `invoke_target`, `cron_expression`, `misfire_policy`,
                       `concurrent`, `status`, `remark`, `create_by`)
VALUES (3, '系统默认（多参）', 'DEFAULT', 'sampleTask.multipleParams(\'iboot\', true, 2000L, 316.50D, 100)',
        '0/20 * * * * ?', 3, 0, 0, '系统默认示例任务（多参数）', 'system');
