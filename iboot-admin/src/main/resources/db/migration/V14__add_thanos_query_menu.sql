...
VALUES (711, 'Thanos 查询', 7, 'C', '/monitor/thanos-query', 'monitor/thanos-query/index', 'monitor:thanos', 'trend',
        12, 1, 1, 'system', NOW());
...
INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`, `create_by`, `create_time`,
                          `deleted`, `remark`)
VALUES (63, 'Thanos 查询地址', 'sys.thanos.query.url', 'http://localhost:19192', 1, 'system', NOW(), 0,
        'Thanos Query 查询页面地址');
