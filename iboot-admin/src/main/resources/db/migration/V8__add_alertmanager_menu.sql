...
VALUES (710, 'Alertmanager', 7, 'C', '/monitor/alertmanager', 'monitor/alertmanager/index', 'monitor:alertmanager',
        'warning-filled', 11, 1, 1, 'system', NOW());
...
INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `config_type`, `create_by`, `create_time`,
                          `deleted`, `remark`)
VALUES (60, 'Alertmanager 告警管理地址', 'sys.alertmanager.monitor.url', 'http://localhost:9093', 1, 'system', NOW(), 0,
        'Alertmanager 告警管理页面地址');
