...
public class MessageTemplateExportVO {
    ...
    public MessageTemplateExportVO() {
    }

    @SuppressWarnings("all")
    public MessageTemplateExportVO(final Long id, final String templateCode, final String templateName,
    ...
    @SuppressWarnings("all")
    public static MessageTemplateExportVO.MessageTemplateExportVOBuilder builder() {
        return new MessageTemplateExportVO.MessageTemplateExportVOBuilder();
    }
    ...
    public boolean equals(final java.lang.Object o) {
        if (o == this)
            return true;
        if (!(o instanceof MessageTemplateExportVO))
            return false;
        final MessageTemplateExportVO other = (MessageTemplateExportVO) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof MessageTemplateExportVO;
    }
    ...
    public java.lang.String toString() {
        return "MessageTemplateExportVO(id=" + this.getId() + ", templateCode=" + this.getTemplateCode()
                ...
                + this.getCreateBy() + ", remark=" + this.getRemark() + ", createTime=" + this.getCreateTime() + ")";
    }

    @SuppressWarnings("all")
    public static class MessageTemplateExportVOBuilder {
        ...
        @SuppressWarnings("all")
        MessageTemplateExportVOBuilder() {
        }
         ...
         */
        @SuppressWarnings("all")
        public MessageTemplateExportVO.MessageTemplateExportVOBuilder id(final Long id) {
            this.id = id;
            return this;
        }
         ...
         */
        @SuppressWarnings("all")
        public MessageTemplateExportVO.MessageTemplateExportVOBuilder templateCode(final String templateCode) {
            this.templateCode = templateCode;
            return this;
        }
         ...
         */
        @SuppressWarnings("all")
        public MessageTemplateExportVO.MessageTemplateExportVOBuilder templateName(final String templateName) {
            this.templateName = templateName;
            return this;
        }
         ...
         */
        @SuppressWarnings("all")
        public MessageTemplateExportVO.MessageTemplateExportVOBuilder templateContent(final String templateContent) {
            this.templateContent = templateContent;
            return this;
        }
         ...
         */
        @SuppressWarnings("all")
        public MessageTemplateExportVO.MessageTemplateExportVOBuilder messageType(final String messageType) {
            this.messageType = messageType;
            return this;
        }
         ...
         */
        @SuppressWarnings("all")
        public MessageTemplateExportVO.MessageTemplateExportVOBuilder status(final Integer status) {
            this.status = status;
            return this;
        }
         ...
         */
        @SuppressWarnings("all")
        public MessageTemplateExportVO.MessageTemplateExportVOBuilder createBy(final String createBy) {
            this.createBy = createBy;
            return this;
        }
         ...
         */
        @SuppressWarnings("all")
        public MessageTemplateExportVO.MessageTemplateExportVOBuilder remark(final String remark) {
            this.remark = remark;
            return this;
        }
         ...
         */
        @SuppressWarnings("all")
        public MessageTemplateExportVO.MessageTemplateExportVOBuilder createTime(final LocalDateTime createTime) {
            this.createTime = createTime;
            return this;
        }

        @SuppressWarnings("all")
        public MessageTemplateExportVO build() {
            return new MessageTemplateExportVO(this.id, this.templateCode, this.templateName, this.templateContent,
                    this.messageType, this.status, this.createBy, this.remark, this.createTime);
        }

        @java.lang.Override
        @SuppressWarnings("all")
        public java.lang.String toString() {
            return "MessageTemplateExportVO.MessageTemplateExportVOBuilder(id=" + this.id + ", templateCode="
                    ...
                    + ", createBy=" + this.createBy + ", remark=" + this.remark + ", createTime=" + this.createTime
                    + ")";
        }
