...
public class CreateUserRequest {
    ...
    @Schema(description = "密码（为空时使用系统默认密码）")
    ...
    public java.lang.String toString() {
        return "CreateUserRequest(username=" + this.getUsername() + ", password=" + this.getPassword() + ", nickname="
                + this.getNickname() + ", email=" + this.getEmail() + ", phone=" + this.getPhone() + ", gender="
                + this.getGender() + ", userType=" + this.getUserType() + ", deptId=" + this.getDeptId() + ", postIds="
                + this.getPostIds() + ", roleIds=" + this.getRoleIds() + ", status=" + this.getStatus() + ", remark="
                + this.getRemark() + ")";
    }
