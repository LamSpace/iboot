...
public class DictDataExportVO {
    ...
    public DictDataExportVO() {
    }

    @SuppressWarnings("all")
    public DictDataExportVO(final Long id, final String dictType, final String dictLabel, final String dictValue,
    ...
    @SuppressWarnings("all")
    public static DictDataExportVO.DictDataExportVOBuilder builder() {
        return new DictDataExportVO.DictDataExportVOBuilder();
    }
    ...
    public boolean equals(final java.lang.Object o) {
        if (o == this)
            return true;
        if (!(o instanceof DictDataExportVO))
            return false;
        final DictDataExportVO other = (DictDataExportVO) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof DictDataExportVO;
    }
    ...
    public java.lang.String toString() {
        return "DictDataExportVO(id=" + this.getId() + ", dictType=" + this.getDictType() + ", dictLabel="
    ...
    @SuppressWarnings("all")
    public static class DictDataExportVOBuilder {
         ...
         */
        @SuppressWarnings("all")
        public DictDataExportVO.DictDataExportVOBuilder id(final Long id) {
            this.id = id;
            return this;
        }
         ...
         */
        @SuppressWarnings("all")
        public DictDataExportVO.DictDataExportVOBuilder dictType(final String dictType) {
            this.dictType = dictType;
            return this;
        }
         ...
         */
        @SuppressWarnings("all")
        public DictDataExportVO.DictDataExportVOBuilder dictLabel(final String dictLabel) {
            this.dictLabel = dictLabel;
            return this;
        }
         ...
         */
        @SuppressWarnings("all")
        public DictDataExportVO.DictDataExportVOBuilder dictValue(final String dictValue) {
            this.dictValue = dictValue;
            return this;
        }
         ...
         */
        @SuppressWarnings("all")
        public DictDataExportVO.DictDataExportVOBuilder orderNum(final Integer orderNum) {
            this.orderNum = orderNum;
            return this;
        }
         ...
         */
        @SuppressWarnings("all")
        public DictDataExportVO.DictDataExportVOBuilder cssClass(final String cssClass) {
            this.cssClass = cssClass;
            return this;
        }
         ...
         */
        @SuppressWarnings("all")
        public DictDataExportVO.DictDataExportVOBuilder listClass(final String listClass) {
            this.listClass = listClass;
            return this;
        }
         ...
         */
        @SuppressWarnings("all")
        public DictDataExportVO.DictDataExportVOBuilder isDefault(final Integer isDefault) {
            this.isDefault = isDefault;
            return this;
        }
         ...
         */
        @SuppressWarnings("all")
        public DictDataExportVO.DictDataExportVOBuilder status(final Integer status) {
            this.status = status;
            return this;
        }
         ...
         */
        @SuppressWarnings("all")
        public DictDataExportVO.DictDataExportVOBuilder remark(final String remark) {
            this.remark = remark;
            return this;
        }
         ...
         */
        @SuppressWarnings("all")
        public DictDataExportVO.DictDataExportVOBuilder createTime(final LocalDateTime createTime) {
            this.createTime = createTime;
            return this;
        }

        @SuppressWarnings("all")
        public DictDataExportVO build() {
            return new DictDataExportVO(this.id, this.dictType, this.dictLabel, this.dictValue, this.orderNum,
        ...
        @SuppressWarnings("all")
        public java.lang.String toString() {
            return "DictDataExportVO.DictDataExportVOBuilder(id=" + this.id + ", dictType=" + this.dictType
