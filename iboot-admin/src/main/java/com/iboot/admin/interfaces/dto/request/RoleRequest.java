...
public class RoleRequest {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof RoleRequest))
            return false;
        final RoleRequest other = (RoleRequest) o;
    ...
    public java.lang.String toString() {
        return "RoleRequest(id=" + this.getId() + ", roleCode=" + this.getRoleCode() + ", roleName="
                + this.getRoleName() + ", orderNum=" + this.getOrderNum() + ", dataScope=" + this.getDataScope()
                + ", status=" + this.getStatus() + ", remark=" + this.getRemark() + ", menuIds=" + this.getMenuIds()
