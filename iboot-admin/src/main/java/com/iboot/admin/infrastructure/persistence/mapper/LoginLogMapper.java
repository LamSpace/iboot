...
public interface LoginLogMapper {
     ...
     */
    @DataScope(deptAlias = "ll", userAlias = "ll")
    List<LoginLogPO> selectPageByCondition(@Param("username") String username, @Param("ipAddress") String ipAddress,
                                           @Param("status") Integer status, @Param("startTime") LocalDateTime startTime,
     ...
     */
    @DataScope(deptAlias = "ll", userAlias = "ll")
    List<LoginLogPO> selectAllByCondition(@Param("username") String username, @Param("ipAddress") String ipAddress,
                                          @Param("status") Integer status, @Param("startTime") LocalDateTime startTime,
                                          @Param("endTime") LocalDateTime endTime);
     ...
     */
    @DataScope(deptAlias = "ll", userAlias = "ll")
    long countByCondition(@Param("username") String username, @Param("ipAddress") String ipAddress,
                          @Param("status") Integer status, @Param("startTime") LocalDateTime startTime,
                          @Param("endTime") LocalDateTime endTime);
     ...
     * @return 独立用户数
     */
    long countDistinctUsers(@Param("startTime") LocalDateTime startTime, @Param("endTime") LocalDateTime endTime);
