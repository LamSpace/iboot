...
public class LoginLogPO {
    ...
    public boolean equals(final java.lang.Object o) {
        if (o == this)
            return true;
        if (!(o instanceof LoginLogPO))
            return false;
        final LoginLogPO other = (LoginLogPO) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof LoginLogPO;
    }
    ...
    public java.lang.String toString() {
        return "LoginLogPO(id=" + this.getId() + ", username=" + this.getUsername() + ", deptId=" + this.getDeptId()
                + ", ipAddress=" + this.getIpAddress() + ", loginLocation=" + this.getLoginLocation() + ", browser="
                + this.getBrowser() + ", os=" + this.getOs() + ", status=" + this.getStatus() + ", message="
                + this.getMessage() + ", loginTime=" + this.getLoginTime() + ", deleted=" + this.getDeleted() + ")";
    }
