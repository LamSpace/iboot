...
public class SampleTask {
    ...
    /**
     * 无参任务方法 调用方式: sampleTask.noParams
     */
    ...
    /**
     * 单参数任务方法 调用方式: sampleTask.withParams('参数值')
     *
     * @param param 字符串参数
     */
    ...
    /**
     * 多参数任务方法 调用方式: sampleTask.multipleParams('字符串', true, 2000L, 316.50D, 100)
     *
     * @param s 字符串参数
     * @param b 布尔参数
     * @param l 长整型参数
