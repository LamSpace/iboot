...
| [06-API 集成](./06-API 集成.md) | API 设计规范、认证授权、请求封装、**细粒度 API 版本控制**、接口列表、数据格式、错误处理 |
...
| [17-国际化设计](./17-国际化设计.md) | 前后端国际化架构、vue-i18n 配置、MessageSource 配置、语言切换流程 |
| [18-国际化开发指南](./18-国际化开发指南.md) | 翻译键添加规范、t() 函数使用、I18nUtil 使用指南、代码示例 |
| [19-虚拟线程指南](./19-虚拟线程指南.md) | JDK 25 虚拟线程原理、配置指南、使用指南、最佳实践、性能测试 |
...
| [16-虚拟线程指南](./16-虚拟线程指南.md) | JDK 25 虚拟线程原理、配置指南、使用指南、最佳实践、性能测试 |
...
11. [国际化设计](./17-国际化设计.md) - 前后端国际化架构、语言切换流程
12. [国际化开发指南](./18-国际化开发指南.md) - 翻译键添加、t() 函数使用、代码示例
