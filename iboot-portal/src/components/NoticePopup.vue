<template>
  ...
  >
      ...
      >
        <div class="notice-header" @click="toggleExpand(notice)">
          <div class="notice-title-row">
            ...
            >置顶</el-tag>
            <el-tag
              :type="dictStore.getDictListClass('sys_notice_type', notice.noticeType)"
              size="small"
            >{{ dictStore.getDictLabel('sys_notice_type', notice.noticeType) }}</el-tag>
    ...
    <template #footer>
      <el-button @click="handleMarkAllRead" :disabled="notices.length === 0">全部已读</el-button>
...
import { getPublishedNotices, markNoticeAsRead, type PublishedNotice } from '@/api/system'
