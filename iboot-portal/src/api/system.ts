...
export function getDictTypeList(
  pageNum = 1,
  pageSize = 10,
): Promise<ApiResponse<PageResult<DictType>>> {
  return request({
    url: "/dict/type/list",
    method: "get",
...
export function getConfigList(
  params: ConfigQuery,
): Promise<ApiResponse<PageResult<Config>>> {
...
): Promise<ApiResponse<PageResult<OperateLog>>> {
  return request({ url: "/log/operate/list", method: "get", params });
}

export function getOperateLogById(
  id: number,
): Promise<ApiResponse<OperateLog>> {
...
export function getRunLogList(
  params: RunLogQuery,
): Promise<ApiResponse<PageResult<RunLog>>> {
...
export function getUserInbox(
  params: UserMessageQuery,
): Promise<ApiResponse<PageResult<UserMessage>>> {
...
export function getAllEnabledTemplates(): Promise<
...
): Promise<ApiResponse<PageResult<OnlineUser>>> {
...
export function getCacheKeyValue(
  key: string,
): Promise<ApiResponse<CacheKeyDetail>> {
  return request({
    url: `/monitor/redis/key/${encodeURIComponent(key)}`,
    method: "get",
  });
}
...
export function getServerMonitorInfo(): Promise<
...
export function cleanJobLog(params: {
  jobId?: number;
  days?: number;
